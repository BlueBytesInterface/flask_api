...
def works_home():
    if request.method == "POST":
        ...
        return render_template("trial_home.html", all_articles=all_articles,
                               keyword=keyword)
    else:
        top_headlines = newsapi.get_top_headlines(country="cn", language="en")
        ...
        return render_template("trial_home.html", all_headlines=all_headlines)
